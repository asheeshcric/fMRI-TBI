...
class FmriDataset(Dataset):
    ...
    def __init__(self, params, data_dir='/data/fmri/data', mask_path='/data/fmri/mask/new_masks/MFG_mask.nii.gz',
                img_shape=(54, 64, 49, 135), img_timesteps=30):
...
#             return score // 20
    ...
    def read_mask(self):
        ...
        mask_img = mask_img.get_fdata()[:nX, :nY, :nZ]
        """
        ...
        return dilated_mask
        """
        return torch.tensor(mask_img, dtype=torch.float, device=self.device)
